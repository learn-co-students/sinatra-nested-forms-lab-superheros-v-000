...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase".freeze, "Alex Rodionov".freeze, "Chris Heald".freeze, "Chris Mytton".freeze, "Corey Ward".freeze, "David Kellum".freeze, "Egor Homakov".freeze, "Florian Gilcher".freeze, "Fojas".freeze, "Mael Clerambault".freeze, "Martin Mauch".freeze, "SAKAI, Kazuaki".freeze, "Stanislav Savulchik".freeze, "Steve Agalloco".freeze, "Akzhan Abdulin".freeze, "TOBY".freeze, "Bj\u00F8rge N\u00E6ss".freeze]
  s.date = "2013-03-13"
